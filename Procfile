...
deploy-srv: ibazel run //deploy/cmd/deploy-srv -- -debug -dry-run -github-token-path=$HOME/.github_auth.txt -poll-interval=15s -terraform=/usr/local/bin/terraform -branch=nomad
